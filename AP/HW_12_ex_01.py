...
Вторая функция read_contacts_from_file читает и возвращает указанный список contacts из файла filename, используя метод
load пакета pickle.
...
def main():
    ...
    write_contacts_to_file('files/hw_12_01.bin', asd)
    print(read_contacts_from_file('files/hw_12_01.bin'))
